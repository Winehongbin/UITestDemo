...
class Choose_Page_Case(unittest.TestCase):
    ...
    def test_001_intoApp(self):
        ...
        try:
            actual_dict=test.cyclic_test_app(25)
        ...
        #                  'sjkb':1,'xsh':1,'xxh':1}
        expected_dict = {'wx':1,'cj':1,'DSPtf':1,'SEMzs':1,'tjzn':1, 'xsh': 1, 'xxh': 1, 'bdgl': 1, 'wj': 1,'cj':1,'tp':1,'wtl':1,'cpgl':1,'gysgl':1,'yjgl':1,'dxgl':1,'wzgl':1,'cygl':1,'jsgl':1}
