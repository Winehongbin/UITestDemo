...
class FieldAction(BasePage):
    ...
    #通过表单名称，找到表单，编辑表单，添加所有字段，删除所有字段，添加两个字段，设置为必填，然后保存
            ...
            print u"添加两个字段："+ChooseFieldName1 + ChooseFieldName2
